# TODO: Ilya Sutskever Mind Profile
...
## Known Information
- **Domain**: llm-training
- **Core Contribution**: Co-invented deep learning approaches behind GPT series; co-authored AlexNet; led GPT-2/3/4 research at OpenAI
- **Key Works**: AlexNet paper (2012), Sequence to Sequence Learning (2014), GPT series research direction
