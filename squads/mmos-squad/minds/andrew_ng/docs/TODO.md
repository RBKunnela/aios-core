...
## Known Information
- **Domain**: ai-entrepreneurs
- **Core Contribution**: Co-founded Google Brain; co-founded Coursera; democratized AI education to millions; brought AI to traditional industries
- **Key Works**: Google Brain project, Coursera ML course (millions of students), DeepLearning.AI specializations
