...
- **Core Contribution**: Created LlamaIndex, the leading open-source framework for building RAG applications
- **Key Works**: LlamaIndex (GPT Index) open-source framework
