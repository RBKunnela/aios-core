# TODO: Clément Delangue Mind Profile
...
- **Core Contribution**: Built Hugging Face into the GitHub of machine learning; made open-source AI a credible alternative to closed-source
- **Key Works**: Hugging Face Hub (1M+ models), Transformers library, Datasets library
