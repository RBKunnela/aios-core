# TODO: Lisa Crispin Mind Profile
...
## Known Information
- **Domain**: qa-testing
- **Core Contribution**: Agile Testing Quadrants model, defining the tester's role in agile teams
- **Key Works**: Agile Testing (2009), More Agile Testing (2014), Holistic Testing (2022) — all with Janet Gregory
