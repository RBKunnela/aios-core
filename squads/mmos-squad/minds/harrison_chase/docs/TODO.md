# TODO: Harrison Chase Mind Profile
...
- **Core Contribution**: Created LangChain, the most widely adopted framework for LLM-powered applications
- **Key Works**: LangChain open-source framework, LangSmith, LangGraph
