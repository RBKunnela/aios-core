# TODO: Naval Ravikant Mind Profile
...
## Known Information
- **Domain**: philosophy-business
- **Core Contribution**: Specific Knowledge theory, Leverage framework, Judgment as the ultimate skill
- **Key Works**: The Almanack of Naval Ravikant, How to Get Rich (tweetstorm), Naval Podcast
