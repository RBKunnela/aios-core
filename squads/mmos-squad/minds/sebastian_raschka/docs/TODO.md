# TODO: Sebastian Raschka Mind Profile
...
## Known Information
- **Domain**: llm-training
- **Core Contribution**: Author of 'Build a Large Language Model From Scratch'; leading researcher on parameter-efficient fine-tuning
- **Key Works**: Build a Large Language Model From Scratch (book), annual State of LLMs reviews
