# TODO: Maaret Pyhäjärvi Mind Profile
...
## Known Information
- **Domain**: qa-testing
- **Core Contribution**: Contemporary Exploratory Testing, Ensemble Programming, Strong-Style Pair Programming
- **Key Works**: Exploratory Testing (book), Ensemble Programming Guidebook, 400+ conference talks
