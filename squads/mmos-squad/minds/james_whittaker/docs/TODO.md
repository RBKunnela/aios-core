# TODO: James Whittaker Mind Profile
...
## Known Information
- **Domain**: qa-testing
- **Core Contribution**: Defined SET/TE roles at Google; systematic approach to exploratory testing through 'tours'
- **Key Works**: How Google Tests Software (2012), Exploratory Software Testing (2009)
