# TODO: Demis Hassabis Mind Profile
...
- **Core Contribution**: Built DeepMind; solved protein folding (AlphaFold); created AlphaGo; now leads Google DeepMind
- **Key Works**: AlphaGo, AlphaFold, AlphaCode, Gemini
