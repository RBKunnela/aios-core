...
## Known Information
- **Domain**: qa-testing
- **Core Contribution**: Rapid Software Testing (RST) methodology, co-founder of Context-Driven School of Testing
- **Key Works**: Taking Testing Seriously (2024), Lessons Learned in Software Testing (2001)
