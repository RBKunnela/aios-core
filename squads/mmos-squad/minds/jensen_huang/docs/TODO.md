# TODO: Jensen Huang Mind Profile
...
- **Core Contribution**: Transformed NVIDIA from gaming GPUs to backbone of all AI computation; bet on accelerated computing before demand existed
- **Key Works**: NVIDIA GPU/CUDA platform, DGX systems, Omniverse
