...
## Known Information
- **Domain**: llm-training
- **Core Contribution**: Created FlashAttention (1, 2, 3) — IO-aware attention achieving 2-4x training speedups, enabling long contexts
- **Key Works**: FlashAttention paper series; FlashAttention-3 utilizes 75% of H100 capability vs 35% before
